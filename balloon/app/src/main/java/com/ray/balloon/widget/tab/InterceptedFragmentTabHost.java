...
/**
 * 改造自{@link android.support.v4.app.FragmentTabHost},
 * 加入了{@link #setTabChangeInterceptor(TabChangeInterceptor)}方法以及{@link TabChangeInterceptor}
 * 来达到控制权限的目的.
 */
public class InterceptedFragmentTabHost extends TabHost
    ...
    public InterceptedFragmentTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
