 ...
 * the License.
 *******************************************************************************/
package com.corelibs.views.pulltorefresh.library;
...
import com.corelibs.views.pulltorefresh.library.internal.EmptyViewMethodAccessor;
import com.corelibs.views.pulltorefresh.library.internal.LoadingLayout;
import com.corelibs.R;

public class PullToMoreListView extends PullToRefreshAdapterViewBase<ListView> {
    ...
    public PullToMoreListView(Context context, Mode mode) {
        super(context, mode);
    }

    public PullToMoreListView(Context context, Mode mode, AnimationStyle style) {
    ...
    final class InternalListViewSDK9 extends InternalListView {
        ...
        protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY,
            ...
            OverscrollHelper.overScrollBy(PullToMoreListView.this, deltaX, scrollX, deltaY,
    ...
    protected class InternalListView extends ListView implements EmptyViewMethodAccessor {
        ...
        public void setEmptyView(View emptyView) {
            PullToMoreListView.this.setEmptyView(emptyView);
        }
