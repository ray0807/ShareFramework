...
public class PullToRefreshSwipeMenuListView extends PullToRefreshAdapterViewBase<SwipeMenuListView> {
    ...
    protected SwipeMenuListView createRefreshableView(Context context, AttributeSet attrs) {
    	SwipeMenuListView lv = new SwipeMenuListView(context, attrs);
    ...
    final class InternalListViewSDK9 extends InternalListView {
        ...
        protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY,
            ...
            OverscrollHelper.overScrollBy(PullToRefreshSwipeMenuListView.this, deltaX, scrollX, deltaY,
    ...
    protected class InternalListView extends ListView implements EmptyViewMethodAccessor {
        ...
        protected void layoutChildren() {
            try {
                ...
                Log.e("InternalListView", "This is not realy dangerous problem");// 这是一个不需要处理的错误。
            }
        }
