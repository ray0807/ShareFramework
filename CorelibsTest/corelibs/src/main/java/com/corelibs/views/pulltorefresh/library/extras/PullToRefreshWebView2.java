 ...
 * the License.
 *******************************************************************************/
package com.corelibs.views.pulltorefresh.library.extras;

import android.content.Context;
import android.util.AttributeSet;
import android.webkit.WebView;

import com.corelibs.views.pulltorefresh.library.PullToRefreshWebView;

import java.util.concurrent.atomic.AtomicBoolean;

/**
 * An advanced version of
 * {@link com.corelibs.views.pulltorefresh.library.PullToRefreshWebView} which
 * delegates the triggering of the PullToRefresh gesture to the Javascript
 * running within the WebView. This means that you should only use this class
 * if:
 * <p/>
 * <ul>
 * <li>{@link com.corelibs.views.pulltorefresh.library.PullToRefreshWebView} doesn't
 * work correctly because you're using <code>overflow:scroll</code> or something
 * else which means {@link WebView#getScrollY()} doesn't return
 * correct values.</li>
