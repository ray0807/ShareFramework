...
import com.corelibs.views.pulltorefresh.library.PullToRefreshSwipeMenuListView;
...
public class LoadingSwipeMenuListView extends PullToRefreshSwipeMenuListView {
	...
	private OnRefreshListener2<SwipeMenuListView> mListener;
	/** 我的状态 **/
	...
	public LoadingSwipeMenuListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public LoadingSwipeMenuListView(Context context, Mode mode) {
		super(context, mode);
		init();
	}

	public LoadingSwipeMenuListView(Context context, Mode mode, AnimationStyle style) {
