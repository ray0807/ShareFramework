...
import com.corelibs.views.cube.ptr.indicator.PtrIndicator;
import com.corelibs.views.cube.ptr.util.PtrCLog;
...
public class PtrFrameLayout extends ViewGroup {
    ...
    public PtrFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mPagingTouchSlop = conf.getScaledTouchSlop() * 0;
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent e) {
        if (mStatus == PTR_STATUS_LOADING || !isEnabled() || mContent == null || mHeaderView == null) {
...
//				}
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                System.out.println(Math.abs(offsetX) +"-"+ mPagingTouchSlop);
               ...
               // System.out.println(mDisableWhenHorizontalMove + "-" + mPreventForHorizontal);
